...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 375 900">
  <defs>
    ...
    <clipPath id="clip-path">
      <rect class="cls-1" width="330" height="777"/>
    </clipPath>
  ...
  <g id="iPhone_6_7_1" data-name="iPhone 6/7 – 1" class="cls-2">
    ...
    <g id="Repeat_Grid_1" data-name="Repeat Grid 2" class="cls-5" transform="translate(23 198)">                            <!-- this is the repeater grid, with specified location -->
...
"""
    ...
    for trip in tripSummaries:
        output = t.render(DAAATE1= makeNiceDate(trip[3][0:10]), StartLoc = trip[1], EndLoc = trip[2], NumberOffset = -240 + i * 60,
                          URLToID = "/tripsCostPage/?id="+trip[0])
        i = i + 1;
...
def generateTripPage(tripSummaries):
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="445 0 375 667">
      ...
      <g id="iPhone_6_7_2" data-name="iPhone 6/7 – 2" class="cls-1">
        ...
        <a href="{{UrlToEmail}}">                                                                                            <!-- CHANGE THIS to link to the Third page! -->
    ...
    JokeURL = Template("""https://www.google.ca/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q={{Number}}/5&*""")
...
<body>
<form action="/actionCompleted" method="post"> <!-- the "action" defines the location URL that the form's collected data is sent to when data is submitted (through the submit button). the "method" defines how the data is sent to that address (Get or post). For more info see https://developer.mozilla.org/en-US/docs/Learn/HTML/Forms/Sending_and_retrieving_form_data -->
    ...
    <div >
        <br>
        <br>
        <text id="Send_Messages" data-name="Send Messages" class="enterEmail"> Enter email addresses: </text>
        <br>
        <br>
        <input type="email" id="mail_one" name="user_mail" class="emailInput"> <!-- email input field 1 -->
        <br>
        <input type="email" id="mail_two" name="user_mail_two" class="emailInput">
        <br>
        <input type="email" id="mail_two" name="user_mail_three" class="emailInput">
        <br>
        <input type="email" id="mail_two" name="user_mail_four" class="emailInput">
        <br>
        <br>
        <br>
        <br>
	...
	<div class="button">
  		<button type="submit" class="submitButton">Send Messages</button>  <!-- submit button for the emails-->
	</div>
